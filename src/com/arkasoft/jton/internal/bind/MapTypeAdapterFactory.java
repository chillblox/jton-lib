...
import com.arkasoft.jton.internal.ObjectConstructor;
 ...
 * <pre>com.arkasoft.jton.JsonParseException: Expecting object found: "(5,6)"
 *   at com.arkasoft.jton.JsonObjectDeserializationVisitor.visitFieldUsingCustomHandler
 *   at com.arkasoft.jton.ObjectNavigator.navigateClassFields
 *   ...</pre>
 *
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
    ...
    private String keyToString(JtonElement keyElement) {
      if (keyElement.isJtonPrimitive()) {
        JtonPrimitive primitive = keyElement.getAsJtonPrimitive();
