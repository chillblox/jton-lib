...
public final class JsonTreeReader extends JsonReader {
  ...
  @Override public JsonToken peek() throws IOException {
    ...
    if (o instanceof Iterator) {
      boolean isObject = stack.get(stack.size() - 2) instanceof JtonObject;
  ...
  @Override public String nextString() throws IOException {
    ...
    return ((JtonPrimitive) popStack()).getAsString();
  }

  @Override public boolean nextBoolean() throws IOException {
    expect(JsonToken.BOOLEAN);
    return ((JtonPrimitive) popStack()).getAsBoolean();
  }
  ...
  @Override public double nextDouble() throws IOException {
    ...
    double result = ((JtonPrimitive) peekStack()).getAsDouble();
  ...
  @Override public long nextLong() throws IOException {
    ...
    long result = ((JtonPrimitive) peekStack()).getAsLong();
    popStack();
    return result;
  }
  ...
  @Override public int nextInt() throws IOException {
    ...
    int result = ((JtonPrimitive) peekStack()).getAsInt();
    popStack();
    return result;
  }
  ...
  public void promoteNameToValue() throws IOException {
    ...
    Map.Entry<?, ?> entry = (Map.Entry<?, ?>) i.next();
    stack.add(entry.getValue());
    stack.add(new JtonPrimitive((String)entry.getKey()));
  }
}
